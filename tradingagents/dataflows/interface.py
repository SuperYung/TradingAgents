...
from .y_finance import get_YFin_data_online, get_stock_stats_indicators_window, get_balance_sheet as get_yfinance_balance_sheet, get_cashflow as get_yfinance_cashflow, get_income_statement as get_yfinance_income_statement, get_insider_transactions as get_yfinance_insider_transactions, get_yfinance_news, get_yfinance_global_news
...
VENDOR_METHODS = {
    ...
    "get_global_news": {
        "yfinance": get_yfinance_global_news,
